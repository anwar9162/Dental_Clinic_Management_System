...
Future<void> showAddDentalHistoryDialog(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: TextField(
                                decoration: InputDecoration(
                                  hintText: 'e.g., Tooth Sensitivity',
                                  labelText: 'Subject',
                            ...
                            Expanded(
                              ...
                              child: TextField(
                                decoration: InputDecoration(
                                  hintText: 'e.g., Mild to severe pain',
                                  labelText: 'Details',
                                  labelStyle: TextStyle(
                                    color: Colors.grey[700],
                                    fontWeight: FontWeight.bold,
              ...
              TextButton(
                ...
                onPressed: () async {
                  ...
                  if (entries.isNotEmpty) {
                    try {
                      await patientApiService.addPastDentalHistory(
                        patient.id ?? '',
                        entries,
                      );
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content:
                                Text('Dental history added successfully.')),
                      );
